  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="status" label="状态" width="80">
        <template slot-scope="scope">
          <el-tag size="small" v-if="scope.row.status === '0'"
            >正常</el-tag
          >
      ...
      <!-- <el-table-column prop="menuType" label="类型" width="80">
        <template slot-scope="scope">
          <el-tag size="small" v-if="scope.row.menuType === 'M'" type="success"
            >目录</el-tag
          >
          <el-tag size="small" v-else-if="scope.row.menuType === 'C'" 
            >菜单</el-tag
          >
          <el-tag size="small" v-else-if="scope.row.menuType === 'F'" type="info"
            >按钮</el-tag
          >
        </template>
      </el-table-column> -->
