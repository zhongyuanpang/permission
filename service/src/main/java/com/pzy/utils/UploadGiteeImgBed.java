...
public class UploadGiteeImgBed {
     ...
     * 码云私人令牌
     */
    public static final String ACCESS_TOKEN = "1706210e180e1ecf847b5f4dc380c8b8";  //这里不展示我自己的了，需要你自己补充

    /**
     * 码云个人空间名
     */
    public static final String OWNER = "nice3527";

    /**
     * 上传指定仓库
     */
    public static final String REPO = "drawingbed";


    /**
     * 上传时指定存放图片路径
     */
    public static final String PATH = "/bbs/"+ DateUtils.getYearMonth()+"/"; //使用到了日期工具类
